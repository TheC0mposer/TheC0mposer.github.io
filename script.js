angular.module('ModuleOne', ['ngSanitize'])
  .controller('MeController',  function($scope) {
    ...
    while consulting the librarians of \"Jquery\" (other programmer\'s on Quora), I was made aware of a tomb not far from here that presented a certain framework that could aid in my holy crusade as a developer;\
    ...
    Using the compasses powers to escape the coming darkness (deadlines) that was chasing me through the tomb of Angular, without a moment\'s notice I was free, \
    ...
    To further my Frontend superpowers I\’ve decided to devote myself to learning the ancient \"Typescripts\" to find any information I can on these special Hierographics I noticed from my previous adventures from before written in a language called \"D3\" while in the tombs of Angular. \
    What seems to be a prophecy I\'ve heard whispers of a necessary evil \"Ionic\'ly\". It is a way to create mobile applications with the skills I have already added to my arsenal.";
  });
  ...
  .controller('EduController', function($scope) {
    ...
    Being a 100% self-motivated, dedicated, and a remote cadet (student) with the hopes and dreams of one day joining an Enterprise crew of his own as an Engineer. \
    The first lessons to be learnt (in codecadmey) were what all must become familiar with, no matter what the intentions, Html and CSS. \
    ...
    I had decided I was to seek out tomb known as Angular, and dance the dance of matrimony, becoming one with the force, potentially never having to go to that place (backend) again. \
  ...
  .controller('EthicController', function($scope) {
    $scope.myHTML = "My lustful passion for clean, RESTful, Minified, and DRY code has grown more from just being preferred and has desire into desire. \
    ...
    A team that won\’t only have my back but one that I can have their \“back\” as well. Fellow Engineers, I get along with and can brainstorm alongside are also amazing traits I cherish in a strike force as well as solid communication to and from the UI/UX\'ers. \
    I am quite familiar with the native dialects of Git; Git-Flow, Github, Cloud 9 and Screen Hero. If a service such as Skype would be required for an interview, I would be able to heed the \"call\" as quickly as I already carry the secret password that was given by the order of Skype, \
